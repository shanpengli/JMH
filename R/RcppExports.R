...
GetBreslowInit <- function(cdata, vi) {
    .Call(`_JMH_GetBreslowInit`, cdata, vi)
}
...
getTruePik <- function(Y, xbeta, wtau, lam1, lam2, alpha1, alpha2, vee1, vee2, Sig, ni, mdataS, xsmatrix, wsmatrix, landmarktime) {
    .Call(`_JMH_getTruePik`, Y, xbeta, wtau, lam1, lam2, alpha1, alpha2, vee1, vee2, Sig, ni, mdataS, xsmatrix, wsmatrix, landmarktime)
}
...
updateH0 <- function(gamma1, gamma2, X2, survtime, cmprsk, FUNEC, vi, H01, H02) {
    .Call(`_JMH_updateH0`, gamma1, gamma2, X2, survtime, cmprsk, FUNEC, vi, H01, H02)
}
