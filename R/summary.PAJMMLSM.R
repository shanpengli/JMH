##' @title Print PAJMMLSM
##' @name summary.PAJMMLSM
##' @aliases summary.PAJMMLSM
##' @param object object of class 'PAJMMLSM'.
...
summary.PAJMMLSM <- function (object, digits = 3, ...) {
  if (!inherits(object, "PAJMMLSM"))
    stop("Use only with 'PAJMMLSM' xs.\n") 
