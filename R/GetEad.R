GetEad <- function(beta, tau, gamma1, gamma2, alpha1, alpha2, vee1, vee2, H01, H02, 
  ...
  for (i in 1:n) {
    ...
    opt <- optim(rep(0, nsig), logLikCR.learn, data = data, method = initial.optimizer, hessian = TRUE)
