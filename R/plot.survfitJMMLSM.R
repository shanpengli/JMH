...
##' over the M replications of the Monte Carlo scheme described in \code{survfitJMMLSM}.
...
##' @export
##' 
plot.survfitJMMLSM <- function (x, estimator = c("both", "mean", "median"), 
